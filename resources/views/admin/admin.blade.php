...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('lte/dist/css/skins/skin-blue.min.css')}}">

  <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
  <!--[if lt IE 9]>
  <script src="('lte/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="('lte/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>SM</b>.io</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SoftMind</b>.io</span>
    </a>
